...
<!-- Image not yet available under static: /images/5-Workshop/5.9-Cleanup/delete-nat-gateway.png -->
<!-- INSERT IMAGE HERE:
Capture the EC2 Build Machine in the Terminated state. Mask the Instance ID and IP address.
Information to mask: Account ID, ARN, public IP address, token, cookie, secret, and user data if displayed.
-->

<!-- Image not yet available under static: /images/5-Workshop/5.9-Cleanup/ec2-terminated.png -->
...
<!-- Image not yet available under static: /images/5-Workshop/5.9-Cleanup/verify-cleanup.png -->
...
- Previous section: [5.8. Security and cost](../5.8-Security-and-cost/)
