...
<!-- Ảnh chưa có trong static: /images/5-Workshop/5.9-Cleanup/delete-nat-gateway.png -->
<!-- CHÈN ẢNH TẠI ĐÂY:
Chụp EC2 Build Machine trạng thái Terminated. Che Instance ID và IP.
Thông tin cần che: Account ID, ARN, địa chỉ IP công khai, token, cookie, secret và dữ liệu người dùng nếu xuất hiện.
-->

<!-- Ảnh chưa có trong static: /images/5-Workshop/5.9-Cleanup/ec2-terminated.png -->
...
<!-- Ảnh chưa có trong static: /images/5-Workshop/5.9-Cleanup/verify-cleanup.png -->
...
- Phần trước: [5.8. Bảo mật và chi phí](../5.8-Security-and-cost/)
